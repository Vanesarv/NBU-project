...
namespace MLModelTextClassification
{
    public partial class MLModel1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"sentence",outputColumnName:@"sentence")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.04457054F,L2Regularization=0.2561964F,LabelColumnName=@"score",FeatureColumnName=@"Features"}), labelColumnName:@"score"))      
